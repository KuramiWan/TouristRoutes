...
public class CouponController extends JeecgController<Coupon, ICouponService> {
	...
	public Result<IPage<Coupon>> queryPageList(Coupon coupon,
	...
	public Result<String> edit(@RequestBody Coupon coupon) {
	...
	public Result<Coupon> queryById(@RequestParam(name="id",required=true) String id) {
    ...
    */
    ...
    public ModelAndView exportXls(HttpServletRequest request, Coupon coupon) {
        return super.exportXls(request, coupon, Coupon.class, "优惠券表");
    }
