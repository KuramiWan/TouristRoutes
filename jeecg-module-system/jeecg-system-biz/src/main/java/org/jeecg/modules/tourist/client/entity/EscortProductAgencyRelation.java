...
/**
 * @Description: 伴游人和产品和旅行社的关系表
 * @Author: jeecg-boot
 * @Date:   2023-06-18
 * @Version: V1.0
 */
@Data
@TableName("escort_product_agency_relation")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="escort_product_agency_relation对象", description="伴游人和产品和旅行社的关系表")
public class EscortProductAgencyRelation implements Serializable {
