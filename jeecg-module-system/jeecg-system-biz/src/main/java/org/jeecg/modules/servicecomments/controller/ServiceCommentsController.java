...
public class ServiceCommentsController extends JeecgController<ServiceComments, IServiceCommentsService> {
	...
	@RequiresPermissions("servicecomments:service_comments:add")
	...
	@RequiresPermissions("servicecomments:service_comments:edit")
	...
	@RequiresPermissions("servicecomments:service_comments:delete")
	...
	@RequiresPermissions("servicecomments:service_comments:deleteBatch")
