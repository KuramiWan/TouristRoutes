...
public class TouristGuideController extends JeecgController<TouristGuide, ITouristGuideService> {
	...
	public Result<IPage<TouristGuide>> queryPageList(TouristGuide touristGuide,
								   @RequestParam(name="pageNo", defaultValue="1") Integer pageNo,
								   @RequestParam(name="pageSize", defaultValue="10") Integer pageSize,
								   HttpServletRequest req) {
		QueryWrapper<TouristGuide> queryWrapper = QueryGenerator.initQueryWrapper(touristGuide, req.getParameterMap());
		Page<TouristGuide> page = new Page<TouristGuide>(pageNo, pageSize);
	...
	@RequiresPermissions("guide:tourist_guide:add")
	...
	@RequiresPermissions("guide:tourist_guide:edit")
	...
	@RequiresPermissions("guide:tourist_guide:delete")
	...
	@RequiresPermissions("guide:tourist_guide:deleteBatch")
