...
public class ProductGuideController extends JeecgController<ProductGuide, IProductGuideService> {
	...
	@RequiresPermissions("productguide:product_guide:add")
	...
	@RequiresPermissions("productguide:product_guide:edit")
	...
	@RequiresPermissions("productguide:product_guide:delete")
	...
	@RequiresPermissions("productguide:product_guide:deleteBatch")
    ...
    * @param productGuide
    */
    @RequiresPermissions("productguide:product_guide:exportXls")
    ...
    * @return
    */
    @RequiresPermissions("productguide:product_guide:importExcel")
